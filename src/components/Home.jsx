...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img src='/assets/rocket.png' alt='rocket' className='absolute right-0 top-0 infinite-up-and-down w-[40px] h-auto md:w-auto' />
        <img src='/assets/code.png' alt='code' className='absolute left-10  infinite-up-and-down w-[40px] h-auto ss:w-auto' />
        <img

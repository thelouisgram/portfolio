...
const Navbar = ({ setNav, nav, activeSection }) => {
    return (
        <section className="h-[80px] fixed top-0 px-4 md:px-0 w-full md:w-[1100px] shadow-2xl md:shadow-none md:mx-auto z-10 bg-[#23252C] flex items-center justify-between text-white font-[700]">
            ...
            <div className="hidden gap-6 items-center md:flex">
                <h2
                    className={`cursor-pointer hover:text-blue-500 ${activeSection === "home" ? "text-blue-500" : ""
                        }`}
                ...
                <h2
                    className={`cursor-pointer hover:text-blue-500 ${activeSection === "skills" ? "text-blue-500" : ""
                        }`}
                ...
                <h2
                    className={`cursor-pointer hover:text-blue-500 ${activeSection === "projects" ? "text-blue-500" : ""
                        }`}
                ...
                <h2
                    className={`cursor-pointer hover:text-blue-500 ${activeSection === "contact" ? "text-blue-500" : ""
                        }`}
